---
name: muhidcasestudy
description: Generate a complete, production-ready case study page from PRD/BRD and designer story. Works standalone or inside ~/portfolio-react. Produces scroll-driven storytelling with granular reveal animations, PDF export, and image placeholders. Use when asked to "/muhidcasestudy" or "generate a case study".
metadata:
  author: muhidul
  version: "2.0.0"
