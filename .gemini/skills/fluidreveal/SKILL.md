---
name: fluidreveal
description: Apply the full FluidReveal animation system to any React + Framer Motion project. Adds Ken Burns on images, per-word hero headline reveals, scroll-driven parallax, per-element staggered section reveals, image reveals with overflow clip, card grid staggers, and hover micro-interactions.
version: "1.0.0"
author: muhidul
---
...
> **Gemini CLI usage:** Run `/fluidreveal` or ask "add animations to this project".
