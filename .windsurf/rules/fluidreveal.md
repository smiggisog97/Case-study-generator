---
trigger: manual
description: Apply the full FluidReveal animation system to any React + Framer Motion project. Adds Ken Burns on images, per-word hero headline reveals, scroll-driven parallax, staggered section reveals, and hover micro-interactions.
---

# FluidReveal — Animation System

> **Windsurf usage:** Reference this rule in Cascade, or ask "add animations to this project".
