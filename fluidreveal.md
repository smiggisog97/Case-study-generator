---
name: fluidreveal
description: Apply the full FluidReveal animation system to any React + Framer Motion project. Adds Ken Burns on images, per-word hero headline reveals, scroll-driven parallax, per-element staggered section reveals, image reveals with overflow clip, card grid staggers, and hover micro-interactions. Use when asked to "/fluidreveal" or "add animations" or "animate this".
metadata:
  author: muhidul
  version: "1.0.0"
